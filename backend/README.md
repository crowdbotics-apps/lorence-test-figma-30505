...
## Project Structure
    ...
    ├── lorence_test_figma_30505  # Django project configurations
...
1. Clone this repo and `cd lorence_test_figma_30505`
...
2. Clone this repo and `cd lorence_test_figma_30505`
